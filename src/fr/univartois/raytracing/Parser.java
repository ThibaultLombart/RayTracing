        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                switch (token) {
                    ...
                    case "diffuse":
                        if (scanner.hasNext()) {
                            scene.setDiffuse(new Color(new Triplet(
                                Double.parseDouble(scanner.next().trim()),
                                Double.parseDouble(scanner.next().trim()),
                                Double.parseDouble(scanner.next().trim())
                            )));
                    ...
                    case "specular":
                        if (scanner.hasNext()) {
                            scene.setSpecular(new Color(new Triplet(
                                Double.parseDouble(scanner.next().trim()),
                                Double.parseDouble(scanner.next().trim()),
                                Double.parseDouble(scanner.next().trim())
                            )));
                    ...
                    case "directional":
                        if (scanner.hasNext()) {
                            ...
                            if (x > 1 || y > 1 || z > 1) {
                                scanner.close();
                                throw new Exception("Value(s) exceed 1");
                            } else {
                    ...
                    case "point":
                        if (scanner.hasNext()) {
                            ...
                            if (x > 1 || y > 1 || z > 1) {
                                ...
                                scene.addLight(new LocalLight(
                                    new Color(t1),
                                    new Point(new Triplet(
                                        Double.parseDouble(scanner.next().trim()),
                                        Double.parseDouble(scanner.next().trim()),
                                        Double.parseDouble(scanner.next().trim())
                                    ))
                    ...
                    case "vertex":
                        if (scanner.hasNext()) {
                            scene.addPoint(new Point(new Triplet(
                                Double.parseDouble(scanner.next().trim()),
                                Double.parseDouble(scanner.next().trim()),
                                Double.parseDouble(scanner.next().trim())
                            )));
                    ...
                    case "tri":
                        if (scanner.hasNext()) {
                            ...
                            if (couleur.getTriplet().getX() > 1 || couleur.getTriplet().getY() > 1 || couleur.getTriplet().getZ() > 1) {
                                ...
                                Point[] listePoints = {
                                    scene.getPoints().get(Integer.parseInt(scanner.next().trim())),
                                    scene.getPoints().get(Integer.parseInt(scanner.next().trim())),
                                    scene.getPoints().get(Integer.parseInt(scanner.next().trim()))
                                };
